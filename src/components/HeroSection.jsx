  ...
  return (
    ...
    >
      <div className="max-w-7xl mx-auto px-4 flex flex-col items-center text-center">
        <motion.div variants={fadeInUp} className="text-white mb-8 border-neutral-800 px-3 py-2 rounded-full text-xs">
        ...
        <motion.div variants={fadeInUp} className="mt-6 space-x-4">
          ...
          <a
            href="#"
            className="inline-block border border-gray-500 hover:border-gray-400 text-white
           py-3 px-6 rounded-lg font-medium"
          >
